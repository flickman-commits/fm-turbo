  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <div className="fixed inset-0 z-50">
        ...
        <DialogContent className="relative !fixed !translate-x-0 !translate-y-0 !top-[20px] !left-[10px] !right-[10px] !bottom-[80px] mx-auto w-[calc(100%-20px)] max-w-2xl bg-white border rounded-lg shadow-lg flex flex-col">
